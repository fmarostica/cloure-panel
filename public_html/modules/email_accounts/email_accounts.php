...
<div id="email_accounts_page" class="gm-uc-page">
    ...
    <div class="gm-uc-page-body">
        ...
        <div class='gm-empty-content'><?= __("email_accounts.empty") ?></div>
        <div class="gm-uc-sidebar"></div>
    </div>
    <div class="gm-uc-page-footer"></div>
</div>

<script src="/modules/email_accounts/email_accounts.js"></script>