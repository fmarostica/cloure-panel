<form id="frmCategoryN1" class="gm-modal" role="dialog" method="post" enctype="multipart/form-data">
...
<script type="text/javascript" src="modules/products_services_categories/modals/md-category-n1.js"></script>