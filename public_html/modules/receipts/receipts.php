...
<div id="receiptsPage" class="gm-uc-page">
    <div class="gm-uc-page-header">
        <div class="gm-uc-page-header-filters">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right">
                        <input placeholder="Buscar" class="form-control toolbar-search" type="search" /><button id="" type="button" class="btn-toolbar">
    ...
    <div class="gm-uc-page-footer">
        ...
        <label class="label-toolbar"><span id="gm-uc-page-footer-total-registers">0</span> Registros encontrados</label>
    </div>
</div>
