		...
		<div class="gm-modal-content">
            ...
            <div class="gm-modal-body">
                ...
                <div class="gm-row">
                    ...
                    <div id="frmUsuarioSeleccionar-lstUsuarios" class="gm-col-12"></div>
                </div>
            </div>
...
<script type="text/javascript" src="modules/propiedades/modals/md-usuario-seleccionar.js?v=7"></script>