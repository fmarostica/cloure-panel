<?php
    include_once __DIR__."/modals/md_activity.php";
...
<div class="gm-uc-page">
    <div class="gm-uc-page-header">
        <div class="gm-uc-page-header-title">Actividades</div>
...
<script src="modules/academy_activities/academy_activities.js"></script>