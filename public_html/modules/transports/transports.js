var ucTransportes = {
    ...
    initialize: function(){
        ...
        $("#btnAgregar").click(function(){
            CloureManager.navigate("transports", "add");
        });
        $("#ucTransportes-lstTransportes").on("click", ".gm-itembox", function(e){
            var id = $(this).data("id");
            CloureManager.navigate("transports", "edit", id);
            e.stopPropagation();
        });
            ...
            success: function(data)
            {
                ...
                if(data.Error==""){
                    if(registros.length>0){
                        ...
                        $(".gm-itembox-container").append("<div class='gm-empty-content'>No tienes transportes cargados."+
                        "</div>");
