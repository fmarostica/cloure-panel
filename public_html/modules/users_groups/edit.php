        ...
        <div id="frmProductosAgregar-tabControl" class="tab-content">
            <div id="home" class="gm-tab-pane active">
                <div class="row">
                    <div class="col-md-12">
                        <label>Nombre</label>
                        <input id="txtName" name="nombre" type="text" class="form-control" placeholder="" value="" />
                    </div>
                    <div class="col-md-12">
                        <label>Descripción</label>
                        <textarea id="txtDescription" name="descripcion" type="text" class="form-control" placeholder="" style="min-height: 80px;"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="/modules/users_groups/edit.js"></script>