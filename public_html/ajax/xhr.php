	...
	if($topic=="change_language"){
		...
		if($topic=="login"){
			if(isset($_POST["module"]) && $_POST["module"]=="users"){
				if(isset($response_decoded->Response->user_token)) $_SESSION["user_token"] = $response_decoded->Response->user_token;
			} else {
				if($response_decoded->Response!=null){
					$_SESSION["app_token"]=$response_decoded->Response->app_token;
					$_SESSION["user_token"]=$response_decoded->Response->user_token;
				}
			}
		}
